...
try {
    ...
    // ✅ আগে invoice আছে কিনা
    $stmt = $pdo->prepare("SELECT id, school_id, in_no, data, paid_at FROM invoices WHERE id = ? LIMIT 1");
    ...
    // ✅ Edit-simple: school_id optional. লগের জন্য payload/DB থেকে school_id নেই
    $schoolIdForLog = $schoolId > 0 ? $schoolId : (int)($row['school_id'] ?? 0);
