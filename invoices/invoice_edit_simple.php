...
// ✅ Edit-only page: school_id না থাকলেও সমস্যা নেই
$school = null;
if ($schoolId > 0) {
    $school = getSchoolById($pdo, $schoolId); // থাকলে fetch
}
if (!$school) {
    // school না থাকলে blank রাখি (edit-এ validation দরকার নাই)
    $school = [
        'id' => (int)$schoolId,
        'school_name' => '',
        'client_name' => '',
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", async function () {
        ...
        document.getElementById("add-invoice-btn").addEventListener("click", async function () {
            ...
            const endpoint = "controllers/invoice_update_simple.php";
