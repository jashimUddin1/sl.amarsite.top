...
$pageTitle = 'Dynamic Invoice Generator';
$pageHeading = 'Invoices';
$activeMenu = 'invoices';

require '../layout/single_invoice_header_copy.php';
?>
                            ...
                            <tr class="item-row">
                                <td>
                                    <input type="text" class="form-control item-desc"
                                        placeholder="Item description / comment" value="">
                                </td>
                                <td>
                                    <input type="number" min="0" step="1" class="form-control item-qty" value="1">
                                </td>
                                <td>
                                    <input type="number" min="0" step="0.01" class="form-control item-rate" value="0">
                                </td>
                                <td>
                                    <input type="number" class="form-control item-amount" value="0.00">
                                </td>
                                <td class="text-end">
    ...
    document.getElementById("view-btn").addEventListener("click", function () {
        ...
        filledRows.forEach((row, idx) => {
            ...
            <tr>
                ...
                <td class="text-end">Tk ${rate.toFixed(2)}</td>
                <td class="text-end">Tk ${amount.toFixed(2)}</td>
            </tr>`;
        });
                ...
                <table class="table invoice-preview-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-white" style="width: 15%; background-color: #1FBD59;">Quantity</th>
                            <th class="text-white" style="width: 20%; background-color: #1FBD59;">Amount</th>
                            <th class="text-white" style="width: 20%; background-color: #1FBD59;">Total</th>
                        </tr>
                    </thead>
                    <tbody>${rowsHtml || `
