...
require_login();
require 'index_file/header_code.php';
...
<body class="bg-gray-100">
  ...
  <!-- Form Section -->
  <div class="no-print container mx-auto p-4 sm:p-6 md:p-8">
    <!-- Increased max-w-5xl to max-w-6xl for a slightly wider form -->


    <!-- Saved Invoices Section -->
    <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8 max-w-6xl mx-auto mt-8">
  ...
  <script type="module">
    document.addEventListener('DOMContentLoaded', function () {
      ...
      async function loadInvoicesFromServer() {
        try {
          const response = await fetch('core/list_invoices.php', {
            method: 'GET',
            headers: {
